...
available for the browser just run `npm run dev` within the root folder on the virtual machine and you should be
able to type `192.168.10.10` in the browser to access the app.
